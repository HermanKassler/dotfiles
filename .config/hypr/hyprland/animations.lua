...
hl.curve("rubber", { type = "spring", mass = 1, stiffness = 450, dampening = 30 })
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 2.5, spring = "rubber", style = "slide" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 2.5, spring = "rubber", style = "slide" })
-- hl.animation({ leaf = "windowsMove", enabled = true, speed = 2.5, bezier = "md3_decel" })
-- hl.animation({ leaf = "windowsIn", enabled = true, speed = 2.5, bezier = "wind2", style = "slide" })
-- hl.animation({ leaf = "windowsOut", enabled = true, speed = 4.79, bezier = "easeOutQuint", style = "slide" })
...
hl.animation({ leaf = "layersIn", enabled = true, speed = 3.79, bezier = "wind" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 5.5, bezier = "easeOutQuint" })
